...
WEBAMI_SCRAPE_WORKERS = 12          # concurrent product scrape threads
...
SHOPIFY_GRAPHQL_URL: LiteralString = f"https://{SHOPIFY_SHOP}/admin/api/{SHOPIFY_API_VERSION}/graphql.json"
...
TEST_SHOPIFY_GRAPHQL_URL: LiteralString = f"https://{TEST_SHOPIFY_SHOP}/admin/api/{SHOPIFY_API_VERSION}/graphql.json"

# --- Pricing ---
MARGIN = 0.34
FORMAT_NAMES: dict[str, str] = {"LP": "Vinyl", "CD": "CD", "Cassette": "Cassette"}
